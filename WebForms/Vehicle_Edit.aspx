<%@ Page Title="Vehicle edit" Language="C#" MasterPageFile="~/DefaultSite.Master" AutoEventWireup="true" CodeBehind="Vehicle_Edit.aspx.cs" Inherits="WebForms.Vehicle_Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="container">
        <div class="title" runat="server" id="vehicleEditTitle"></div>
        <div class="row">
            <div class="col-md-6">
